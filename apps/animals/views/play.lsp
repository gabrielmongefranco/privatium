<?-- Project: Privatium™ | apps/animals/views/play.lsp
     Summary: The page around the board. The board itself is _board.lsp, because HTMX swaps
              it and a full page reload would lose the scroll position and the focus ring
              for no reason.
