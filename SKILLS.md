...
- [privatium-overview](skills/privatium-overview/SKILL.md),
  [privatium-tier1-lua](skills/privatium-tier1-lua/SKILL.md),
  [privatium-tier2-web](skills/privatium-tier2-web/SKILL.md),
  [privatium-tier3-rust](skills/privatium-tier3-rust/SKILL.md),
  [privatium-security](skills/privatium-security/SKILL.md),
  [privatium-accessibility](skills/privatium-accessibility/SKILL.md),
  [privatium-games](skills/privatium-games/SKILL.md): instruction sets for building apps
  on this framework. Load the tier skill for the app you are writing, plus the security
  and accessibility skills. Their `reference/` folders are generated by
  `cargo xtask gen-skill-reference`; never edit a generated file by hand.
