...
// crates/privatium/tests/common/mod.rs
// Author(s): Gabriel Mongefranco
// Created: 2026-09-07
// Last Modified: 2026-09-07
// Summary: In-process nodes behind real TCP sockets and TEST-NET peer addresses for encrypted
//          synchronization tests (spec/protocol.md §8.3 and §10). The nodes run in this
//          process because a test has to start a pass and then look inside both of them, which
//          a node running as a child binary cannot be asked to do.
