...
// crates/privatium-core/tests/identity.rs
// Author(s): Gabriel Mongefranco
// Created: 2026-09-01
// Last Modified: 2026-09-05
// Summary: Node and cluster identities, certificate validation and renewal, secret exclusion, and
//          identity selection after restore (spec/protocol.md §2).
