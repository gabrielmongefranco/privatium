...
// crates/privatium-core/tests/snapshot.rs
// Author(s): Gabriel Mongefranco
// Created: 2026-09-02
// Last Modified: 2026-09-06
// Summary: spec/protocol.md §5 — the snapshot id and manifest, the three-tier read with real bytes
//          flipped on disk, when a snapshot does not apply, retention that never prunes the
//          oldest, verification, the weekly policy, and where the tier used is recorded.
