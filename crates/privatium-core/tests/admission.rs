...
// crates/privatium-core/tests/admission.rs
// Author(s): Gabriel Mongefranco
// Created: 2026-09-07
// Last Modified: 2026-09-07
// Summary: Node admission against spec/protocol.md §2.3–§2.3.4, §6.1 and §7.4.2: two nodes in one
//          process, each in its own data root, the eight messages driven as data through
//          Node::pairing_* on the window's side and Node::join_* on the dialer's, in both
//          directions; disposability, the swap, the expired state, re-admission, renewal at
//          runtime, revocation, and the cluster filter.
