...
// crates/privatium-core/src/lint/css.rs
// Author(s): Gabriel Mongefranco
// Created: 2026-09-05
// Last Modified: 2026-09-06
// Summary: What PV406 (spec/cli.md §5.1) reads: a stylesheet's `:root` tokens and rules, `var()`
//          resolution, and the WCAG 2.x relative-luminance contrast ratio — the same maths
//          tests/common/a11y.rs applies to the shell's own stylesheet, shared here so an app's
//          declared tokens are held to the same floors. Nothing here panics on a colour it
//          cannot read; an unreadable value is simply not checked.
