...
// crates/privatium-core/src/discover/txt.rs
// Author(s): Gabriel Mongefranco
// Created: 2026-09-06
// Last Modified: 2026-09-06
// Summary: The TXT record of spec/protocol.md §6.1 — the eight keys in the table's order, built from
//          the node's facts, with `apps` truncated to `,…` so the whole record stays under
//          1300 bytes — and the reading of one back into a Discovered, with every key off the
//          wire judged before it is kept.
