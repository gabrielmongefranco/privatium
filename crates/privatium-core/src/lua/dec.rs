...
// crates/privatium-core/src/lua/dec.rs
// Author(s): Gabriel Mongefranco
// Created: 2026-09-03
// Last Modified: 2026-09-03
// Summary: pv.dec (spec/lua-api.md §3.2): store::Decimal as a Lua userdata. Construction from a string
//          or an integer, never a float; + - * and unary minus exact and erroring on overflow
//          rather than saturating; comparison across scales; `/` at the larger scale of the
//          operands, rounded half away from zero, and `:div` for an author who wants to name
//          the scale.
