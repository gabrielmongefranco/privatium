...
// crates/privatium-core/src/lua/html.rs
// Author(s): Gabriel Mongefranco
// Created: 2026-09-03
// Last Modified: 2026-09-03
// Summary: The one value `<?= ?>` emits without escaping (spec/lua-api.md §4): markup the framework
//          itself produced — icon(), csrf(), render(), a layout's content. A string is data
//          and is escaped; an Html is markup and passes. Concatenating one into a string
//          yields a plain string, which is then escaped again: losing the marker is the safe
//          direction, and there is no flag to change any of it.
