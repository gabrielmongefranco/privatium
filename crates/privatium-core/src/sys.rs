...
// crates/privatium-core/src/sys.rs
// Author(s): Gabriel Mongefranco
// Created: 2026-09-01
// Last Modified: 2026-09-07
// Summary: Public node and cluster records, device and app registries, snapshot facts, and audit kinds,
//          written through the same event log apps use (spec/data-dictionary.md §3).
