...
// crates/privatium-core/src/log/mod.rs
// Author(s): Gabriel Mongefranco
// Created: 2026-09-01
// Last Modified: 2026-09-07
// Summary: The append-only event log (spec/protocol.md §4). This module is the timestamp printer, the
//          `op` and envelope types, and AppLog — one app's log, which owns the §4.3 Lamport
//          counter and the single writer §3.1 allows this node.
