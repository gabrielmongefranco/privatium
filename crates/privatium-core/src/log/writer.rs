...
// crates/privatium-core/src/log/writer.rs
// Author(s): Gabriel Mongefranco
// Created: 2026-09-01
// Last Modified: 2026-09-06
// Summary: The single writer of one data/<slug>/log/<dev>.jsonl (AGENTS.md 2). Appends puts,
//          tombstones, and all-or-nothing batches, with `seq` gapless per spec/protocol.md
//          §4.1 and the clock read here rather than taken from a caller.
