...
// crates/privatium-core/src/log/envelope.rs
// Author(s): Gabriel Mongefranco
// Created: 2026-09-01
// Last Modified: 2026-09-06
// Summary: The two halves of spec/protocol.md §4.1 — the struct a writer serializes, and the much
//          smaller struct a reader deserializes. They are separate types on purpose: §4.2
//          makes preservation a property of the bytes, so nothing here ever reads a line and
//          writes it back out.
