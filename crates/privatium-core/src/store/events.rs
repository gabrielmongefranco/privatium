...
// crates/privatium-core/src/store/events.rs
// Author(s): Gabriel Mongefranco
// Created: 2026-09-03
// Last Modified: 2026-09-07
// Summary: The staged log: every sane event of one app, read from data/<slug>/log/*.jsonl once, and
//          spec/protocol.md §4.5's ranking over it. The materializer, the three restore tiers
//          and the snapshot writer all work from this one reading, which is what keeps the
//          incremental apply and the full replay structurally equal. Reading only: nothing
//          here writes or forwards a line (§4.2).
