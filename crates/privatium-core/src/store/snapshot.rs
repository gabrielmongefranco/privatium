...
// crates/privatium-core/src/store/snapshot.rs
// Author(s): Gabriel Mongefranco
// Created: 2026-09-02
// Last Modified: 2026-09-05
// Summary: spec/protocol.md §5.1, §5.2 and §5.4 — the snapshot id, MANIFEST.json, the writer that
//          produces one snapshot directory from the log (a SQLite file and a CSV per table),
//          checksum verification (spec/cli.md §7), retention, and the weekly policy of
