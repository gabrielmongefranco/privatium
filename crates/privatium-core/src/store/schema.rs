...
// crates/privatium-core/src/store/schema.rs
// Author(s): Gabriel Mongefranco
// Created: 2026-09-01
// Last Modified: 2026-09-06
// Summary: What a schema.sql declares, learned from SQLite's own catalog rather than from a parser of
//          its own: tables, the declared type of every column, NOT NULL, and views. The
//          declared type decides how the materializer stores a column (spec/data-dictionary.md
//          §2), because SQLite would otherwise decide by affinity and turn a DECIMAL into a
//          float.
