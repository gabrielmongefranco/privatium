...
// crates/privatium-core/src/store/restore.rs
// Author(s): Gabriel Mongefranco
// Created: 2026-09-02
// Last Modified: 2026-09-05
// Summary: spec/protocol.md §5.3 — the three-tier read. The snapshot's SQLite files plus the log tail,
//          then CSV plus schema.sql plus the tail, then the full replay; which tier succeeded,
