...
// crates/privatium-core/src/store/query.rs
// Author(s): Gabriel Mongefranco
// Created: 2026-09-05
// Last Modified: 2026-09-06
// Summary: One statement on the sandboxed connection, its rows as JSON typed by the schema
//          (spec/data-api.md §1, spec/data-dictionary.md §2.1): what the data API answers and
//          what Node::query hands an embedder (spec/app-contract.md §6), through one function
//          so the two cannot type a column differently.
