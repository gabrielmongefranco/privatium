...
// crates/privatium-core/src/http/csrf.rs
// Author(s): Gabriel Mongefranco
// Created: 2026-09-03
// Last Modified: 2026-09-06
// Summary: The csrf() token of spec/lua-api.md §4.1: HMAC-SHA256 over node_id ‖ nonce ‖ path under a
//          key HKDF-derived from the node key by Identity::csrf_key. Nothing is written to
//          disk; the nonce lives for the process, so a restart invalidates every outstanding
//          form, which on one machine is correct and unremarkable.
