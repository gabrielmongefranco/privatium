...
// crates/privatium-core/src/session/handshake.rs
// Author(s): Gabriel Mongefranco
// Created: 2026-09-05
// Last Modified: 2026-09-05
// Summary: Transport-independent hello and confirmation state machines. Pins and certificate
//          verification gate session establishment (spec/protocol.md §8.3).
