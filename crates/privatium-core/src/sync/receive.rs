// Project:  Privatium™  |  File: crates/privatium-core/src/sync/receive.rs
// Authors:  Gabriel Mongefranco (@gabrielmongefranco)
// Created:  2026-09-07  |  Modified: 2026-09-07
// Summary:  Foreign log validation, cache rebuilds, and notification delivery for
//           spec/protocol.md §10.2, §4.3 and spec/lua-api.md §3.4.
