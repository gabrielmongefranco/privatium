...
// crates/privatium-core/src/sync/engine.rs
// Author(s): Gabriel Mongefranco
// Created: 2026-09-07
// Last Modified: 2026-09-07
// Summary: Encrypted peer synchronization over the existing application channel, with durable inbox
//          acknowledgements and bounded failover (spec/protocol.md §10).
