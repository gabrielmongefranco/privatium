...
// crates/privatium-core/src/sync/routes.rs
// Author(s): Gabriel Mongefranco
// Created: 2026-09-07
// Last Modified: 2026-09-07
// Summary: Node-only heads, pull, and push routes through core::handle, with bounded input and raw
//          response streams (spec/protocol.md §9.2 and §10.2).
