...
// crates/privatium-core/src/local.rs
// Author(s): Gabriel Mongefranco
// Created: 2026-09-01
// Last Modified: 2026-09-07
// Summary: local/state.jsonl — the node-local state of spec/protocol.md §3. Never synced, never backed
//          up, and never required for restore. It holds one record per app — the Lamport
//          counter and the highest `seq` seen per device — and the peer hints of
