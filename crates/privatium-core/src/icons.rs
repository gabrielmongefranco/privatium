...
// crates/privatium-core/src/icons.rs
// Author(s): Gabriel Mongefranco
// Created: 2026-09-03
// Last Modified: 2026-09-06
// Summary: Bootstrap Icons, vendored in full under assets/icons/ and embedded in the binary
//          (docs/icons.md). The one helper that turns a name into an inline <svg>, with the
//          accessibility attributes the icon system makes mandatory and the fallback an
//          unknown name renders instead of nothing.
