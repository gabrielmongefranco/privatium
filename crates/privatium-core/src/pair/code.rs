...
// crates/privatium-core/src/pair/code.rs
// Author(s): Gabriel Mongefranco
// Created: 2026-09-05
// Last Modified: 2026-09-05
// Summary: The 16-bit pairing code, its two normative renderings — four glyphs and two words — and the
//          parser that accepts either, or the glyphs' labels (spec/protocol.md §7.2, §7.3,
