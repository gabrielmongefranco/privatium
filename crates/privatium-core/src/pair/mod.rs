...
// crates/privatium-core/src/pair/mod.rs
// Author(s): Gabriel Mongefranco
// Created: 2026-09-05
// Last Modified: 2026-09-07
// Summary: The pairing window (spec/protocol.md §7.1, §7.5): one code at a time, held in memory beside
//          its PAKE secret and never written, with its TTL, its attempt cap, its per-source
//          rate limit and the refusals each produces.
